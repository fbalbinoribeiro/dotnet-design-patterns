...
public sealed record ReadyState(AudioPlayer AudioPlayer) : AbstractState(AudioPlayer)
{
	...
	public override void ClickPlay() => AudioPlayer.ChangeState(new PlayingState(AudioPlayer));
