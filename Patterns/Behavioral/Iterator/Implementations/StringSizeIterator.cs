...
public sealed record StringSizeIterator : IEnumerator<string>
{
	private readonly WordsCollection _collection;
	private int _position = -1;

	public StringSizeIterator(WordsCollection collection)
	{
		_collection = collection;
		_collection.GetItems().Sort((x, y) => x.Length.CompareTo(y.Length));
	}
